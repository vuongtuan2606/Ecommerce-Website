...
import com.qtsneaker.ShopBackEnd.services.report.MasterOrderReportService;
import com.qtsneaker.ShopBackEnd.services.report.OrderDetailReportService;
import com.qtsneaker.ShopBackEnd.services.report.ReportItem;
import com.qtsneaker.ShopBackEnd.services.report.ReportType;
...
public class ReportRestController {
	...
	public List<ReportItem> getReportDataByDatePeriod(@PathVariable("period") String period) {
		...
		switch (period) {
			...
			case "last_30_days":
				return masterOrderReportService.getReportDataLast30Days(ReportType.DAY);
	...
	public List<ReportItem> getReportDataByCategoryOrProduct(@PathVariable("groupBy") String groupBy,
		...
		switch (period) {
			...
			case "last_30_days":
				return orderDetailReportService.getReportDataLast30Days(reportType);
